...
public class JhromeTabbedPaneUI extends TabbedPaneUI
{
		...
		MouseAdapter	adapter	= new MouseAdapter( )
								{
                                    ...
                                    {
                                        if( !tabbedPane.isEnabled( ) || SwingUtilities.isMiddleMouseButton(e))
                                        {
                                            return;
                                        }
                                    ...
                                    private boolean maybeClose(MouseEvent e, Tab tab)
									{
	...
	private void removeDraggedTabFromParent( TabDragInfo dragInfo )
	{
		...
		if( draggedParent != null )
		{
			...
			Tab parentSelectedTab = draggedParent.getSelectedTab();
